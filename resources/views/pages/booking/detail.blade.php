...
<div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
    ...
    <p class="font-semibold">Booking Detail</p>
    ...
    <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
        ...
        <div class="flex gap-4">
            ...
            <div class="flex items-center gap-[6px]">
                ...
                <p class="text-sm text-ngekos-grey">{{ $transaction->room->square_feet}} M^2</p>
            </div>
                <hr class="border-[#F1F2F6]">
...
<div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
    ...
    <div class="flex flex-col gap-4 pt-[22px]">
        ...
        <div class="flex items-center justify-between">
            ...
            @else
            <p class="font-semibold">Rp {{ number_format($down_payment, 0, ',', '.') }}</p>
            @endif
        </div>
...
<div id="BottomButton" class="relative flex w-full h-[98px] shrink-0">
    <div class="fixed bottom-[30px] w-full max-w-[640px] px-5 z-10">
        <a href="https://wa.me/+6282126261180" class="flex w-full justify-center rounded-full p-[14px_20px] bg-ngekos-orange font-bold text-white">Contact Customer Service</a>
    </div>
</div>
@endsection
@section('scripts')
